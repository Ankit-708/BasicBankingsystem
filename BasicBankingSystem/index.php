...
<html lang="en">
  ...
  ?>
      ...
      <div class="container-fluid">
            ...
            <div class="row intro py-1">
              ...
              <div class="col-sm-12 col-md img text-center">
                <img class="im" src="img/bank2.jfif" class="img-fluid pt-2">
              </div>
            </div>
          <br>
          <br>
          ...
          <h3 class="action" ><span style="font-family: 'Roboto Slab', serif">CHOOSE AN ACTION</h3></span>
            <div class="column activity text-center">
                  ...
                  <div class="col-md act">
                    ...
                    <br>
                    <br>
                    <a href="transfermoney.php"><button>View Customers or transfer</button></a>
                  </div>
      ...
      <footer class="text-center mt-5 py-2">
        <p>A Project by <b>ANKIT VISHWAKARMA</b> <br> </p>
      </footer>
